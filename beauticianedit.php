...
<br><br>
<form   id="add_meal" method="POST" action="beauticianeditback.php" enctype="multipart/form-data">
 
                            <div class="input-group">
     <span class="input-group-addon" style="color:white">Driver ID &nbsp;&nbsp;&nbsp;  :-    </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input id="beauticianId" type="text" class="form-control" name="beauticianId" placeholder="beauticianId"  readonly value="<?php echo $row['beauticianId'];  ?>" required autofocus> </div>
      <br>
