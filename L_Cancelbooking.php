...
<?php
        ...
        if(isset($_POST['register'])){
          ...
          $register_query = "INSERT INTO `cbooking`(`cbookingID `,`email`, `bId`, `reason`) VALUES ('','$email','$bId','$reason')";
		  $register_query1 = "Delete from booking where bId=$bId";
		 
          try{
               $register_result = mysqli_query($conn, $register_query);
			   $register_result = mysqli_query($conn, $register_query1);
            if(mysqli_affected_rows($conn)>0){
              echo '<script>alert("package cancel is Successfully !!")</script>';
        echo '<script>window.location="L_Cancelbooking.php"</script>';
}
            else{
             
            echo"<script>alert('error in cancel');</script>";
 echo '<script>window.location="L_Cancelbooking.php"</script>';
            }
...
<div class="col-15">
              <div class="thumbnail" style="width:100%",>
                  ...
                  <center><div class="col-md-12 col-sm-12 alert-info">
                           <br> <h3>Cancel Service Booking</h3>
                           
                    </div></center>
                  
                        <form class="form-horizontal w3-left w3-border " id="register-form1" method="post" action="L_Cancelbooking.php">
                        <br>                      
                        ...
                        <div class="col-lg-30">
                        <div class="input-group">
                            <span style="color:gray">Booking ID:- </span><input id="address" type="text" class="form-control" name="bId" placeholder="pBookingId" required autofocus><center></div><span style="color:gray"><small>[Refer Your Profile]</small></span></center></div><br>
