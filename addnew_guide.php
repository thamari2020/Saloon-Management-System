...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <li class="nav-item">
    <form action="add_newguide.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="New Guide" name="submit">
 ...
 <li class="nav-item" >
     ...
     <li class="nav-item" >
       <form action="add_leaveguide.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="Guide Leave" name="submit">
...
<div class="w3-half w3-padding">      
    <input class="w3-input w3-border" name="gName" type="text" placeholder="Guide Name"  id="gName" onkeypress="return (event.charCode > 64 && 
...
<div class="w3-padding">
  ...
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div>
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" size = '12' name="gNIC" type="text" placeholder="Guide NIC"  id="gNIC" pattern=".{10,}"></div>               
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gEmail" type="email" placeholder="Guide Email"  id="gEmail"></div>   
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gPhoneNo" type="number" size= '10' placeholder="Guide Phone No"  id="gPhoneNo" onkeypress="return (event.charCode >45  && event.charCode < 59)" pattern="(?=.*[0-9]).{10,}"></div>   
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gqualification" type="text" placeholder="Guide qualification"  id="gqualification" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div>   
     <br />
<div class="w3-padding">
