...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['cbookingID'];  echo "</td>";
                              echo "<td>"; echo $row['email'];  echo "</td>";
                              echo "<td>"; echo $row['bId'];  echo "</td>";
                              echo "<td>"; echo $row['reason'];  echo "</td>";
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_cancelbooking_delete.php?id={$row["cbookingID"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
...
<h1> <u>Cancel Package Booking</u> </h1>
         <div class="row  w3-margin" >
              <div class ="container">
              <table class="table table-striped table-bordered" id="example" style="width: 95%;">
                <thead>
                  <tr>
                    <th>Cancel Package Booking ID</th>
                    <th>User Mail</th>
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['cpackagesID'];  echo "</td>";
                              echo "<td>"; echo $row['email'];  echo "</td>";
                              echo "<td>"; echo $row['pBookingId'];  echo "</td>";
                              echo "<td>"; echo $row['reason'];  echo "</td>";
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_cancelbooking_delete.php?id={$row["cpackagesID"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
