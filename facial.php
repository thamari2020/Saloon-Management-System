...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">Facial</div>
  </div>
</div>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      <a href="haircut.php" class="w3-bar-item w3-black w3-button">1</a>
      <a href="haircolouring.php" class="w3-bar-item w3-button w3-hover-black">2</a>
      <a href="hairtreatment.php" class="w3-bar-item w3-button w3-hover-black">3</a>
      <a href="facial.php" class="w3-bar-item w3-button w3-hover-black">4</a>
      <a href="makeup.php" class="w3-bar-item w3-button w3-hover-black">5</a>
	   <a href="manicure.php" class="w3-bar-item w3-button w3-hover-black">6</a>
    </div>
  </div>
