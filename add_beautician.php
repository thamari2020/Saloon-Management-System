...
<div>
  <h1> <u>beautician</u> </h1>
          ...
          <br />             
          <div class="col-sm-12">
            <button style="float:right;" class="btn btn-dark" type="button" onClick= "window.location.href ='addnew_beautician.php';" ><i class=></i>Add New beautician</button>
          </div>
                 </td></tr></table>       
          </div>
<br /><br /><br /><br />
              ...
              <table class="table table-striped table-bordered" id="example" style="width: 95%;">
                <thead>
                  <tr>
                    ...
                    <th>beautician Email</th>
                    <th>beautician Phone Number</th>
                    <th>beautician Age</th>
                    <th>beautician Qualification</th>
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              ...
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_beautician_delete.php?id={$row["beauticianId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
