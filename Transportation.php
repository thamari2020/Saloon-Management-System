...
<?php
        ...
        <form method="post" >
          <div  style="background-color: #0a2e4f; border-radius:5px; padding:16px; width: 80%;" align="center">
           ...
           <th></th><th> <h5 class="text-info"><font color="white"><?php echo $row["vName"]; ?><br>Rs<?php echo $row["fees"]; ?>  Per KM
              ...
              <br>Description:- <?php echo $row["vDescription"]; ?><font> </h5></font></th></tr></table> 
...
<div class="text-right"> <a href="login.php"> <div class ="text-right btn btn-success">Book Transportation</div></a></div>
