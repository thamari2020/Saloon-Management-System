...
<br><br>
     ...
     <span class="input-group-addon" style="color:white">beautician ID &nbsp;&nbsp;&nbsp;  :-    </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input id="beauticianId" type="text" class="form-control" name="beauticianId" placeholder="beauticianId Id"  readonly value="<?php echo $row['beauticianId'];  ?>" required autofocus> </div>
      <br>

           <div class="input-group">
     <span class="input-group-addon" style="color:white">beautician Name &nbsp;&nbsp;&nbsp;  :-    </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="input-group">
     <span class="input-group-addon" style="color:white">Qualification  &nbsp;&nbsp;&nbsp;  :-    </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <br>
        <br><br>                     
 <div>
<a href="beauticianedit.php"><img src="img\edit.png" width="100px" height="50px"></a>
 </div>                             
