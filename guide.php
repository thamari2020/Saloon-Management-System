...
<?php
        ...
        <form method="post" >
          <div  style=" background-color:#0a2e4f; border-radius:5px; padding:16px;" align="center">
           <table><tr><th> <img src="in\upload\<?php echo $row["Image"]; ?>" class="img-responsive" /><th>
...
<div class="text-right">   <a href="login.php"> <div class ="text-right btn btn-success">Book Guide</div></a></div>
...
<div class="text-right">
    ...
    <a href="Transportation.php"><button type="button" class="btn btn-success">Transport</button> </a>
