                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              ...
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_leaveBabarDelete.php?id={$row["LGId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
