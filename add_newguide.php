...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <form action="add_newBabar.php" method="POST">                 
      ...
      <li class="nav-item">
        <form action="add_newbeautician.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="Newbeautician" name="submit">
 ...
 <li class="nav-item" >
       <form action="add_leavebeautician.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="beauticianLeave" name="submit">
