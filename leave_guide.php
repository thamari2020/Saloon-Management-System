...
?>
                    ...
                    <form class="form-horizontal w3-left w3-border w3-light-gray" id="register1" method="post" action="./leave_guideBack.php" style="color: white;">   <h1 style="color: white;">Leave Application for guide</h1> </b><br >
                                                        <div class="col-lg-90">
                        <div class="input-group">
     <span class="input-group-addon">Guide ID  &nbsp;&nbsp;&nbsp;:-&nbsp;&nbsp;&nbsp;    </span>
     ...
     <span class="input-group-addon" >E-mail &nbsp;&nbsp;&nbsp; :-&nbsp;&nbsp;&nbsp;    </span>
      <input id="gEmail" type="text" class="form-control" name="gEmail" placeholder="Guide Mail" readonly value="<?php echo $row['gEmail'];  ?>" required autofocus> </div>
      <br>
