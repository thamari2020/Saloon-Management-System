...
<center>
<div style="background-color: #E0E6F8; width: 60% "> <br><h1><u> Add a Transport</u></h1>    
                                    
<form   id="add_meal" method="POST" action="addnew_tr_back.php" enctype="multipart/form-data">

<div class="w3-half w3-padding">      
    <input class="w3-input w3-border" name="vName" type="text" placeholder="Vehicle Name"  id="vName" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div><br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="howManyPeople" type="text" placeholder="How May People can travel"  id="howManyPeople" onkeypress="return (event.charCode >45  && event.charCode < 59)"></div>            
...
<input type="file" name="photo" id="fileSelect" class="w3-btn w3-block w3-black w3-padding-large">
 <p><strong>Note:</strong> Only .jpg, .jpeg, .gif, .png formats allowed to a max size of 5 MB.</p>
                                                    ...
                                                    <div class="w3-padding">
     <input class="w3-input w3-border" name="fees" type="text" placeholder="Amount per KM"  id="fees"></div onkeypress="return (event.charCode >45  && event.charCode < 59)">      <br />

       <div class="w3-padding">
     <input class="w3-input w3-border" name="vDescription" type="text" placeholder="Description"  id="fees" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div>      <br />
