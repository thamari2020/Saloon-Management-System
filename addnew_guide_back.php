...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
        ...
        if(in_array($filetype, $allowed)){
            // Check whether file exists before uploading it
               ...
               $sql = "INSERT INTO guide (guideId, gName,language,gNIC,gEmail,gPhoneNo,gqualification,password,Image,fees,availabledate) VALUES('','$gName','$language','$gNIC','$gEmail','$gPhoneNo','$gqualification','$password','$filename','$fees','2020-10-12');";
				echo $sql;
...
echo $register_query1;
		  ...
		  mysqli_query($conn,$$register_query1);
                echo '<script>alert("Successfully Add New Guide")</script>';
