...
?>
                    ...
                    <form class="form-horizontal w3-left w3-border w3-light-gray" id="register1" method="post" action="./leave_beauticianBack.php" style="color: white;">   <h1 style="color: white;">Leave Application for beautician</h1> </b><br >
                                                        <div class="col-lg-90">
                        <div class="input-group">
     <span class="input-group-addon" >beautician ID  &nbsp;&nbsp;&nbsp;:-&nbsp;&nbsp;&nbsp;    </span>
      <input id="guideId" type="text" class="form-control" name="beauticianId" placeholder="beauticianId"  readonly value="<?php echo $row['beauticianId'];  ?>" required autofocus> </div>
      <br>
      
                               <div class="input-group">
     <span class="input-group-addon">E-mail &nbsp;&nbsp;&nbsp; :- &nbsp;&nbsp;&nbsp;   </span>
      <input id="gEmail" type="text" class="form-control" name="dEmail" placeholder="beautician Mail" readonly value="<?php echo $row['dEmail'];  ?>" required autofocus> </div>
      <br>

                               <div class="input-group">
     <span class="input-group-addon">Leave Start Date  &nbsp;&nbsp;&nbsp;:-&nbsp;&nbsp;&nbsp;    </span>
      <br>
                                  <input type="date" name="sdate" min="2021-01-21" max="2021-12-31" class="w3-input w3-border" required="required" placeholder="Select Your date" /><br></div><br>

                                   <div class="input-group">
     <span class="input-group-addon">Leave End Date&nbsp;&nbsp;&nbsp;  :- &nbsp;&nbsp;&nbsp;   </span>
      
                                  <input type="date" name="edate" min="2021-01-21" max="2021-12-31" class="w3-input w3-border" required="required" placeholder="Select Your date" /></div><br>
                                  <br />
    ...
    <div class="footer" id="footer">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4  col-md-3 col-sm-5 col-xs-7"> <br><br>
                ...
                <div class="col-lg-1  col-md-3 col-sm-5 col-xs-7"> <br><br>
 
                    <h3> Contact </h3>
 
                    <ul>
 
                       <li> <a href="www.facebook.com"> <i class=" fa fa-facebook"><img src="img\facebook.png" width="7%" height="5%">  Facebook</i> </a> </li>

                        <li> <a href="www.instagram.com"> <i class="fa fa-twitter"><img src="img\insta.jpg" width="7%" height="5%">  Instagram   </i> </a> </li>

                        <li> <a href="www.Twitter.com"> <i class="fa fa-google-plus"> <img src="img\twitter.png" width="7%" height="5%"> Twitter   </i> </a> </li>
 
                        <li> <a href="www.Gmail.com"> <i class="fa fa-pinterest"> <img src="img\gmail.png" width="7%" height="5%">  Gmail  </i> </a> </li>
