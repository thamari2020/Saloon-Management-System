...
<center>
  <h1> <u>Leave beautician Details</u> </h1>
          <div class="col-sm-12">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                        ...
                        $sql = "SELECT * FROM leave_beautician";
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['leavebeauticianId'];  echo "</td>";
                              ...
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_leavebeauticianDelete.php?id={$row["leavebeauticianId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
