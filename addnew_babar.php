...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    ...
    <form action="add_newbabar.php" method="POST">                 
      ...
      <li class="nav-item">
        <form action="add_newdriver.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="New Driver" name="submit">
 ...
 <li class="nav-item" >
       <form action="add_leavedriver.php" method="POST">                 
                  ...
                  <input style="padding-top:5px;" class="btn btn-dark nav-link" type="submit" value="Driver Leave" name="submit">
...
<center>
<div style="background-color: #E0E6F8; width: 60% "> <br><h1> Add a babar</h1>    
                                    
<form   id="add_meal" method="POST" action="addnew_babar_back.php" enctype="multipart/form-data">

<div class="w3-half w3-padding">      
    <input class="w3-input w3-border" name="gName" type="text" placeholder="babar Name"  id="gName" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div><br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="language" type="text" placeholder="language"  id="language" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div>
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" size = '12' name="gNIC" type="text" placeholder="babar NIC"  id="gNIC" pattern=".{10,}"></div>               
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gEmail" type="email" placeholder="babar Email"  id="gEmail"></div>   
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gPhoneNo" type="number" size= '10' placeholder="babar Phone No"  id="gPhoneNo" onkeypress="return (event.charCode >45  && event.charCode < 59)" pattern="(?=.*[0-9]).{10,}"></div>   
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="gqualification" type="text" placeholder="babar qualification"  id="gqualification" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"></div>   
     <br />
<div class="w3-padding">
     <input class="w3-input w3-border" name="password" type="password" placeholder="password"  id="password" ></div>   
...
<div class="w3-half">
<input type="submit" class="w3-btn w3-green w3-block " name="meal_add" value="Add babar">
                                                </div> <br />
<div class="w3-half">
