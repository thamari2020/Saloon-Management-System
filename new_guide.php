...
<div class="col-15">
              <div class="thumbnail" style="width:100%";>
                    <center><b>
                    	<form class="form-horizontal w3-left w3-border w3-light-gray" id="register-form" enctype="multipart/form-data" method="post" action="./new_guideBack.php">
                  ...
                  <center><div class="col-md-12 col-sm-12 alert-info">
                        ...
                        <div class="input-group">
                            <span>First Name&nbsp;&nbsp;&nbsp;:-&nbsp;&nbsp;&nbsp; </span><input id="fname" type="text" class="form-control" name="nGuideFname" onkeypress="return (event.charCode > 64 && 
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"  placeholder="First Name" required autofocus> </div></div><br>

                        <div class="col-lg-30">
                        <div class="input-group">
                            <span>Last Name&nbsp;&nbsp;&nbsp;:-&nbsp;&nbsp;&nbsp; </span><input id="lname" type="text" class="form-control" name="nGuideLname" onkeypress="return (event.charCode > 64 && 
