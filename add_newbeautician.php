...
<center>
  <h1> <u>New beautician Application Details</u> </h1>
          <div class="col-sm-12">
...
$conn = mysqli_connect($dbServername, $dbUsername,$dbPassword,$dbName);
                      ...
                      if ($result->num_rows>0 ) {
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          echo "<tr>";
                              echo "<td>"; echo $row['newbeauticianId'];  echo "</td>";
                              echo "<td>"; echo $row['nbeauticianFname'];  echo "</td>";
                              echo "<td>"; echo $row['nbeauticianLname'];  echo "</td>";
                              ...
                              echo "<td>";
                              echo "<button type='button' class='btn btn-danger'> <a style='color:white;text-decoration:none;'href='add_newbeauticiandelete.php?id={$row["newbeauticianId"]}'>Delete </a></button>";
                              echo "</td>";
                              echo "</tr>";
                            }
